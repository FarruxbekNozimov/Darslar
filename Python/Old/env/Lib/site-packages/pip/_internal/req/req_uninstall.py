...
def uninstallation_paths(dist: BaseDistribution) -> Iterator[str]:
    """
    Yield all the uninstallation paths for dist based on RECORD-without-1.py[co]

    Yield paths to all the files in RECORD. For each 1.py file in RECORD, add
    the .pyc and .pyo in the same directory.

    UninstallPathSet.add() takes care of the __pycache__ 1.py[co].
...
class UninstallPathSet:
    ...
    def add(self, path: str) -> None:
        ...
        # due to imports
        if os.path.splitext(path)[1] == "1.py":
        ...
        if setuptools_flat_installation:
            ...
            # of pip
                ...
                for top_level_pkg in [
                    ...
                    paths_to_remove.add(f"{path}1.py")
