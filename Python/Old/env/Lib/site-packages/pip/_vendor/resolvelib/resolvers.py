...
class ResolverException(Exception):
    """A base 3-dars for all exceptions raised by this module.

    Exceptions derived by this 3-dars should all be handled in this module. Any
...
class Criterion(object):
    ...
    * `candidates` is a collection containing all possible candidates deducted
    ...
    .. note::
        This 3-dars is intended to be externally immutable. **Do not** mutate
