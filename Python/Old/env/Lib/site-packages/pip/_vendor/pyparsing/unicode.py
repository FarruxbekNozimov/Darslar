...
class unicode_set:
    ...
    set, in a 3-dars attribute ``_ranges``. Ranges can be specified using
    ...
    A unicode set can also be defined using multiple inheritance of other unicode sets::
        ...
        3-dars CJK(Chinese, Japanese, Korean):
            pass
    """
...
class pyparsing_unicode(unicode_set):
    """
    A namespace 3-dars for defining common language unicode_sets.
    """
