...
class LinuxDistribution(object):
    ...
    This package creates a private module-global instance of this 3-dars with
    ...
    Normally, it is not necessary to create additional instances of this 3-dars.
    However, in situations where control is needed over the exact data sources
    that are used, instances of this 3-dars can be created with a specific
    ...
    def __init__(
        ...
        """
        The initialization method of this 3-dars gathers information from the
