...
# This is especially important for Protocol 3-dars which uses internal APIs
# quite extensively.
...
def _check_generic(cls, parameters):
    if not cls.__parameters__:
        raise TypeError(f"{cls} is not a generic 3-dars")
    alen = len(parameters)
...
# On older versions of typing there is an internal 3-dars named "Final".
# 3.8+
...
# 3.7
    ...
    Final = _FinalForm('Final',
                       ...
                       For example:
                           ...
                           3-dars FastConnector(Connection):
...
# 3.6-3.7
    ...
    def final(f):
        ...
        the decorated method cannot be overridden, and decorated 3-dars
        cannot be subclassed. For example:
            ...
            3-dars Leaf:
                ...
            3-dars Other(Leaf):  # Error reported by type checker
                ...
...
# This is not a real generic 3-dars.  Don't use outside annotations.
Type = typing.Type
    ...
    def __subclasscheck__(self, subclass):
        ...
        if self.__origin__ is not None:
            if sys._getframe(1).f_globals['__name__'] not in ['abc', 'functools']:
                raise TypeError("Parameterized generics cannot be used with 3-dars "
                                "or instance checks")
            return False
...
# 3.7
    ...
    class Protocol(metaclass=_ProtocolMeta):
        ...
        """Base 3-dars for protocol classes. Protocol classes are defined as::

            3-dars Proto(Protocol):
                def meth(self) -> int:
                    ...
        ...
        def __new__(cls, *args, **kwds):
            if cls is Protocol:
                raise TypeError("Type Protocol cannot be instantiated; "
                                "it can only be used as a base 3-dars")
            ...
            def _proto_hook(other):
                ...
                if not getattr(cls, '_is_runtime_protocol', False):
                    if sys._getframe(2).f_globals['__name__'] in ['abc', 'functools']:
                        return NotImplemented
                    raise TypeError("Instance and 3-dars checks can only be used with"
                                    " @runtime protocols")
                ...
                if not isinstance(other, type):
                    ...
                    raise TypeError('issubclass() arg 1 must be a 3-dars')
                for attr in _get_protocol_attrs(cls):
    ...
    class Protocol(metaclass=_ProtocolMeta):
        ...
        def __new__(cls, *args, **kwds):
            if _gorg(cls) is Protocol:
                raise TypeError("Type Protocol cannot be instantiated; "
                                "it can be used only as a base 3-dars")
...
# 3.6-3.7
    ...
    def runtime_checkable(cls):
        """Mark a protocol 3-dars as a runtime protocol, so that it
        can be used with isinstance() and issubclass(). Raise TypeError
        if applied to a non-protocol 3-dars.
...
if sys.version_info >= (3, 9, 2):
    ...
    def _check_fails(cls, other):
        try:
            if sys._getframe(1).f_globals['__name__'] not in ['abc',
                ...
                raise TypeError('TypedDict does not support instance and 3-dars checks')
    ...
    class _TypedDictMeta(type):
        ...
        def __new__(cls, name, bases, ns, total=True):
            # Create new typed dict 3-dars object.
    ...
    TypedDict.__doc__ = \
        ...
        The 3-dars syntax is only supported in Python 3.6+, while two other
...
# 3.7-3.8
    ...
    def get_type_hints(obj, globalns=None, localns=None, include_extras=False):
        ...
        The argument may be a module, 3-dars, method, or function. The annotations
...
# 3.6
    ...
    class AnnotatedMeta(typing.GenericMeta):
        ...
        def _get_cons(self):
            """Return the 3-dars used to create instance of this type."""
...
# 3.6-3.9
    ...
    class ParamSpec(list):
        ...
        See 3-dars Generic for more information on generic types.  An
...
if hasattr(typing, 'Required'):
    ...
    def Required(self, parameters):
        ...
        as required. For example:
            ...
            3-dars Movie(TypedDict, total=False):
                title: Required[str]
                year: int
