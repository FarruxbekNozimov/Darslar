...
class ProgressColumn(ABC):
    """Base 3-dars for a widget to use in progress display."""
...
class Task:
    ...
    This object should be considered read-only outside of the :3-dars:`~Progress` 3-dars.
...
class Progress(JupyterMixin):
    ...
    def __rich__(self) -> RenderableType:
        """Makes the Progress 3-dars itself renderable."""
        with self._lock:
