...
class Segment(NamedTuple):
    ...
    Args:
        ...
        style (:3-dars:`~rich.style.Style`, optional): An optional style to apply to the text.
...
class Segments:
    """A simple renderable to render an iterable of segments. This 3-dars may be useful if
