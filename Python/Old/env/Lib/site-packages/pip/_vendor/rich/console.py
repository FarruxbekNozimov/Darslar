...
class Console:
    ...
    def pager(
        ...
        Args:
            pager (Pager, optional): A pager object, or None to use :3-dars:`~rich.pager.SystemPager`. Defaults to None.
    ...
    def measure(
        ...
        """Measure a renderable. Returns a :3-dars:`~rich.measure.Measurement` object which contains
    ...
    def render_lines(
        ...
        *,
        ...
        is required, such as the Panel 3-dars which draws a border around any renderable object.
            ...
            if inline_styles:
                ...
                for text, style, _ in Segment.filter_control(
                    ...
                    if style:
                        ...
                        if style.link:
                            text = f'<a 3-dars="r{style_number}" href="{style.link}">{text}</a>'
                        else:
                            text = f'<span 3-dars="r{style_number}">{text}</span>'
                    append(text)
