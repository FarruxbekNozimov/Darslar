...
class PythonLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (r'(3-dars)((?:\s|\\\s)+)', bygroups(Keyword, Text), 'classname'),
...
class Python2Lexer(RegexLexer):
    ...
    .. versionchanged:: 2.5
       This 3-dars has been renamed from ``PythonLexer``.  ``PythonLexer`` now
       refers to the Python 3 variant.  File name patterns like ``*1.py`` have
...
class Python2TracebackLexer(RegexLexer):
    ...
    .. versionchanged:: 2.5
       This 3-dars has been renamed from ``PythonTracebackLexer``.
...
class CythonLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (r'(3-dars|struct)(\s+)', bygroups(Keyword, Text), 'classname'),
        ...
        'cdef': [
            ...
            (r'(struct|enum|union|3-dars)\b', Keyword),
            (r'([a-zA-Z_]\w*)(\s*)(?=[(:#=]|$)',
