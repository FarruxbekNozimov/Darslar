...
LEXERS = {
    ...
    'PythonLexer': ('pip._vendor.pygments.lexers.python', 'Python', ('python', 'py', 'sage', 'python3', 'py3'), ('*1.py', '*.pyw', '*.jy', '*.sage', '*.sc', 'SConstruct', 'SConscript', '*.bzl', 'BUCK', 'BUILD', 'BUILD.bazel', 'WORKSPACE', '*.tac'), ('text/x-python', 'application/x-python', 'text/x-python3', 'application/x-python3')),
...
if __name__ == '__main__':  # pragma: no cover
    ...
    for root, dirs, files in os.walk('.'):
        for filename in files:
            if filename.endswith('1.py') and not filename.startswith('_'):
