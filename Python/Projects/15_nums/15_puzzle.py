...
class Numbers_15(QWidget):
    ...
    def something(self):
        for x in range(60, -1, -1):
            self.counter.emit(f"TIMER: {x:03d}")
            time.sleep(0.1)
        self.shuffle_board()
        self.a = 0
    ...
    def start(self):
        ...
        self.setStyleSheet("color: #fff;background-image:url('2.jpg');border-radius: 20px;margin:5px;font: 40pt Agency FB;border:1px solid #000")
        ...
        self.img.setPixmap(QPixmap('o.jpg'))
        self.img.setScaledContents(True)
        self.emp_stl = "background-image:url('o.jpg');box-shadow: rgba(0, 0, 0, 0.17) 0px -23px 25px 0px inset, rgba(0, 0, 0, 0.15) 0px -36px 30px 0px inset, rgba(0, 0, 0, 0.1) 0px -79px 40px 0px inset, rgba(0, 0, 0, 0.06) 0px 2px 1px, rgba(0, 0, 0, 0.09) 0px 4px 2px, rgba(0, 0, 0, 0.09) 0px 8px 4px, rgba(0, 0, 0, 0.09) 0px 16px 8px, rgba(0, 0, 0, 0.09) 0px 32px 16px;"

        self.border = QLabel(self)
        self.border.setGeometry(0, 0, 500, 460)
        self.border.setStyleSheet(f"{self.emp_stl}; border:3px solid #555;")
        self.border1 = QLabel(self)
        self.border1.setGeometry(0, 457, 500, 97)
        self.border1.setStyleSheet(f"{self.emp_stl}; border:3px dashed #555;")
        ...
        self.time_btn = QPushButton('TIMER: 1000', self)
        ...
        self.restart.setGeometry(10, 465, 85, 80)
        self.move.setGeometry(93, 465, 190, 80)
        self.time_btn.setGeometry(280, 465, 210, 80)
...
# ============================================================================
        ...
        self.restart.setStyleSheet("background-image:url('2.jpg');color: white;border:2px solid black;font: 30pt Agency FB;")
        self.move.setStyleSheet("background-image:url('2.jpg');color: white;border:2px solid black;font: 30pt Agency FB;")
        self.time_btn.setStyleSheet("background-image:url('2.jpg');color: white;border:2px solid black;font: 30pt Agency FB;")
        self.shuffle_board()
        self.check_win()
        self.a = 0
    def play(self, cl_btn):
        ...
        if cl_btn.text() != '':
            ...
            if i - 1 >= 0 and self.btns[i-1][j].text() == '':
                ...
                cl_btn.setText('')
                self.moves += 1
        self.move.setText(f"MOVE: {self.moves :02d}")
        self.check_win()
        if self.a == 1:
            self.startCounting()
